...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        '''
        model = Post
        fields = ['id', 'author', 'author_username', 'content', 'image', 'created_at', 'updated_at', 'comments', 'likesCount', 'is_liked']
    ...
    def get_is_liked(self, obj):
        ...
        if user.is_authenticated:
            ...
            return Like.objects.filter(post=obj, author=user).exists()
        return False
