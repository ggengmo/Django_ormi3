# 목표
---
1. 모델을 만들어서 데이터를 DB에 저장하고 템플릿에 템플릿 태그로 출력
...
>>> Post.objects.all()[:2]
<QuerySet [<Post: 제목: 1, 시간: 2023-10-11 02:20>, <Post: 제목: 2, 시간: 2023-10-11 02:20>]>
>>> Post.objects.filter(title = '1') 
<QuerySet [<Post: 제목: 1, 시간: 2023-10-11 02:20>]>
>>> Post.objects.filter(id = '1')    
<QuerySet [<Post: 제목: 1, 시간: 2023-10-11 02:20>]>
>>> Post.objects.filter(title__contains='test')
<QuerySet []>
>>> Post.objects.filter(contents__contains = '2')    
<QuerySet [<Post: 제목: 2, 시간: 2023-10-11 02:20>]>
Post.objects.filter(contents__contains = '2').filter(contents__contains = '2')
...
<QuerySet [<Post: 제목: 2, 시간: 2023-10-11 02:20>, <Post: 제목: test sample, 시간: 2023-10-11 04:19>]>
...
<Post: 제목: test sample, 시간: 2023-10-11 04:19>
>>> Post.objects.all() 
<QuerySet [<Post: 제목: 1, 시간: 2023-10-11 02:20>, <Post: 제목: 2, 시간: 2023-10-11 02:20>, <Post: 제목: 3, 시간: 2023-10-11 02:20>]>
...
>>> q.save()
>>> Post.objects.all()        
<QuerySet [<Post: 제목: hello, 시간: 2023-10-11 02:20>, <Post: 제목: 2, 시간: 2023-10-11 02:20>, <Post: 제목: 3, 시간: 2023-10-11 02:20>]>
...
# 다운로드 받아 실행한 후 '데이터베이스 구조' 말고 '데이터 보기' 탭 클릭하여 테이블을 'blog_post' 선택 후 데이터 삭제하고 '변경사항 저장하기' 한 다음 Django에서 확인
2. 덮어쓰기
