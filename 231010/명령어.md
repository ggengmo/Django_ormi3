...
{% load static %} # base.html 상단에 1번 입력
base.html로 옮긴 코드들 사이에 content 선언
... 코드 ...
{% block content %} # base.html로 옮긴 코드들 사이에 content 선언
{% endblock %}
... 코드 ...
...
{% block content %}
{% load static %} # 만약 static 불러오는 오류 생기면 입력.
... 코드 ...
{% endblock %} # 자식 html 제일 마지막에 입력.
